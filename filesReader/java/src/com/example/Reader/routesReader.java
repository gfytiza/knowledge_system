...
public class routesReader {
    private Model model;
    private static final String SAMPLE_CSV_FILE_PATH = "./routes.txt";
    OutputStream out = new FileOutputStream("routes-data.ttl");

    public routesReader() throws FileNotFoundException {
    }
    ...
    public void createModel(String [] nextRecord){
        ...
        addStatement(ns+nextRecord[0], nsRDFS+"type", ns+"routes");
    ...
    public static void main(String[] args) throws IOException {
        ...
        routesReader dave = new routesReader();
